...
SELECT LOWER(FIRSTNAME) AS LOWER_FIRSTNAME , UPPER(LASTNAME) AS UPPER_LASTNAME 
FROM EMPLOYEE
...
SELECT LEFT(FIRSTNAME,3) AS LEFT_3_CHAR_FIRSTNAME 
FROM EMPLOYEE

--20. Display LASTNAME with last 2 characters only.
SELECT RIGHT(LASTNAME,2) AS RIGHT_2_CHAR_LASTNAME 
FROM EMPLOYEE
...
SELECT FIRSTNAME, REVERSE(FIRSTNAME) AS REVERSE_FIRSTNAME 
FROM EMPLOYEE
