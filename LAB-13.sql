...
SELECT * 
FROM STUDENT_INFO S LEFT JOIN RESULT R
ON S.RNO = R.RNO
...
SELECT * 
FROM RESULT R RIGHT JOIN STUDENT_INFO S
ON S.RNO = R.RNO
...
SELECT * 
FROM STUDENT_INFO S FULL JOIN RESULT R
ON S.RNO = R.RNO
...
SELECT S.BRANCH , MAX(R.SPI)-MIN(R.SPI) AS DIFFERENCE_OF_SPI
FROM STUDENT_INFO S INNER JOIN RESULT R
ON S.RNO = R.RNO
GROUP BY S.BRANCH
