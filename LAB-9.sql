...
SELECT CITY,SUM(SALARY) AS TOTAL_SAL_CITY FROM EMPLOYEE
WHERE CITY IS NOT NULL
GROUP BY CITY
HAVING SUM(SALARY) > 20000

--2. Display departments having average salary greater than 12000.
SELECT DEPARTMENT,AVG(SALARY) AS AVG_SAL_DEPARTMENT FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING AVG(SALARY) > 12000

--3. Display departments having total salary greater than 20000.
SELECT DEPARTMENT,SUM(SALARY) AS TOTAL_SAL_DEPARTMENT FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING SUM(SALARY) > 20000

--4. Display departments having number of employees greater than 2.
SELECT DEPARTMENT,COUNT(EID) AS TOTAL_EMPLOYEE FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING SUM(EID) > 2
...
SELECT CITY,AVG(SALARY) AS AVG_SAL_CITY FROM EMPLOYEE
WHERE CITY IS NOT NULL
GROUP BY CITY
HAVING AVG(SALARY) < 12000

--7. Display departments where maximum salary greater than 14000.
SELECT DEPARTMENT,MAX(SALARY) AS MIN_SAL_DEPARTMENT FROM EMPLOYEE
GROUP BY DEPARTMENT
...
SELECT CITY,SUM(SALARY) AS TOTAL_SAL_CITY_MALE FROM EMPLOYEE
...
SELECT DEPARTMENT,MAX(SALARY) AS MAX_SAL_DEPARTMENT FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING MAX(SALARY) > 13000
ORDER BY MAX(SALARY)
...
SELECT DEPARTMENT,COUNT(EID) AS JOINING_AFTER_2022 FROM EMPLOYEE
WHERE JOININGYEAR > 2022
GROUP BY DEPARTMENT
HAVING COUNT(EID) > 1

--19. Display departments where average salary of female employees greater than 8000.
SELECT DEPARTMENT,AVG(SALARY) AS AVG_SAL_DEAPRTMENT_FEMALE FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY DEPARTMENT
HAVING AVG(SALARY) > 8000

--20. Display departments having total salary greater than 20000 and less than 40000.
SELECT DEPARTMENT,AVG(SALARY) AS AVG_SAL_DEAPRTMENT FROM EMPLOYEE
GROUP BY DEPARTMENT
...
SELECT DEPARTMENT,SUM(SALARY) AS TOTAL_SAL_DEPARTMENT_FEMALE FROM EMPLOYEE
WHERE GENDER = 'FEMALE'
GROUP BY DEPARTMENT
HAVING SUM(SALARY) < 15000

--26. Display cities where number of male employees greater than female employees.
SELECT CITY,COUNT(EID) AS EMPLOYEE_NUMBER FROM EMPLOYEE
WHERE CITY IS NOT NULL
GROUP BY CITY
...
SELECT DEPARTMENT,COUNT(CITY) AS CITY_NUMBER FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING COUNT(CITY) > 1
